...
const PMTopbar = (props) => {
    ...
    useEffect(() => {
        if(cookies.get('loggedInUser')) {
            let userName = cookies.get('loggedInUser')
            setUsername(userName)
        } else {
            toastSetting('error', 'Session Expired', 'You need to login again.', true)
                ...
                <ul className="topbar-menu">
                    ...
                    <li className={profileItemClassName}>
                        <button type="button" className="p-link" onClick={props.onTopbarUserMenu}>
                            <img src="assets/demo/images/avatar/user.png" alt="diamond-layout" className="profile-image" />
                        ...
                        <ul className="profile-menu fade-in-up">
                            ...
                            <li>
                                <button onClick={goToLogin} type="button" className="p-link">
